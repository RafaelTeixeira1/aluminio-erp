...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Consolide entradas e saidas financeiras com visao de caixa realizado e projetado.</p>
        </div>
        <div class="flex items-center gap-2">
            <a href="{{ route('cashflow.exportCsv', request()->query()) }}" class="bg-emerald-100 text-emerald-800 px-4 py-2 rounded-lg hover:bg-emerald-200 transition">
                Exportar CSV
            </a>
            <a href="{{ route('cashflow.exportPdf', request()->query()) }}" target="_blank" class="bg-slate-100 text-slate-800 px-4 py-2 rounded-lg hover:bg-slate-200 transition">
                Exportar PDF
            </a>
        </div>
    </div>
    ...
    <form method="GET" action="{{ route('cashflow.index') }}" class="bg-white rounded-lg shadow p-4">
        <div class="grid grid-cols-1 md:grid-cols-6 gap-3">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('cashflow.index') }}" class="bg-gray-200 text-gray-900 px-4 py-2 rounded-lg hover:bg-gray-300 transition">Limpar</a>
            </div>
        </div>
    </form>
